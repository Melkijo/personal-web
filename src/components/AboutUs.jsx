      ...
      <Container>
        <Row className="">
          <Col className="about-activity" lg={4} md={12}>
            ...
            >
              My
              <span style={{ color: "#01CC8E" }}> Experience</span>{" "}
            </p>
            <ul>
              <li>
          ...
          <Col className="about-story" lg={4} md={12}>
            ...
            <p>
              my name is Melki Jonathan Andara. Currently, I am pursuing my
              education at Mataram University and I am in the 6th semester of
              the Informatics Engineering program. I have a deep interest in the
              field of technology because it offers knowledge that can be
              applied in various domains. I aspire to become a software engineer
